                ...
                <tr v-for="finance in finances" :key="finance.Event">
                  ...
                  <td>
                    <span class="fs-xs fw-semibold d-inline-block py-1 px-3 rounded-pill" :class="{
                      'bg-success-light text-success': parseInt(finance.Amount) > 0,
                      'bg-danger-light text-danger': parseInt(finance.Amount) < 0,
                    }">
                      {{ finance.Amount }}
                    </span>
                  </td>
              ...
              <tbody class="fs-sm">
                <tr>
                  ...
                  <td class="d-none d-sm-table-cell">
                    <p class="fs-xs fw-semibold mb-0">Через СБП</p>
                  </td>
